...
Both models produce similar individual-level elasticity estimates for the
selected stores. With about 117 weekly observations per store, the
...
of demographics. HART allows nonlinear and interaction structure in
`Z` through `Delta(Z)`.
